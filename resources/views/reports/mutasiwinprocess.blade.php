                ...
                <div class="nav-table px-1">
                    <div class="row d-flex">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="submit" class="btn btn-danger" formaction="exportpdfmutasiwip"
                                formtarget="_blank"><i class="fas fa-print"></i><span> Print</span></button>
                            <button type="submit" formaction="exportexcelmutasiwipdownload" class="btn btn-success"><i
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
