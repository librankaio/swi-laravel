            ...
            --}}
                                ...
                                @if ($no == 0)
                                    @foreach ($results as $key => $item)
                                        <tr>
                                            ...
                                            @else
                                                <td class="border-2">
                                                    {{ 'Rp. ' . number_format($item->nilai_barang, 2, '.', ',') }}</td>
                                            @endif
              ...
              <td colspan="2" colspan="2" class="border-2">Nilai Barang</td>
                            ...
                            <tr align="center" class="" style="font-weight: bold;">
                                ...
                                <td align="center" colspan="2" class="border-2 border-start-0">Bukti Penerimaan Barang
                                </td>
              ...
              <th scope="col" class="border-top-0 border-bottom-0  border-2">USD</th>
                            ...
                            <tr align="center">
                                ...
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0">Nomor
                                    Pendaftaran</th>
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0">Tanggal
                                </th>
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0">Nomor
                                </th>
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0">Tanggal
                                ...
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0"></th>
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0"></th>
                                <th scope="col" class="border-top-0 border-bottom-0  border-2 border-start-0">Rupiah
                                </th>
