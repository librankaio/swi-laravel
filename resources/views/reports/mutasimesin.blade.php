                ...
                <div class="nav-table px-1">
                    <div class="row d-flex">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="submit" class="btn btn-danger" formaction="exportpdfmutasimesin"
                                formtarget="_blank"><i class="fas fa-print"></i><span> Print</span></button>
                            <button type="submit" formaction="exportexcelmutasimesindownload" class="btn btn-success"><i
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_awal, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        @endforeach
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_in, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        @endforeach
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_out, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        @endforeach
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_adj, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        @endforeach
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_akhir, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
                                ...
                                <div class="px-2 pt-1">
                                    ...
                                    @if (isset($results))
                                        ...
                                        @endforeach
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="{{ number_format($total_stock_opname, 2, '.', ',') }}" readonly>
                                    @else
                                        <input type="text" class="form-control" style="height: 30px; width: 150px;"
                                            value="0" readonly>
                                    @endif
