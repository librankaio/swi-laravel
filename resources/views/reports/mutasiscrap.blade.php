                ...
                <div class="nav-table px-1">
                    <div class="row d-flex">
                        ...
                        <div class="col-md-6 text-end">
                            <button type="submit" class="btn btn-danger" formaction="exportpdfscrap"
                                formtarget="_target"><i class="fas fa-print"></i><span> Print</span></button>
                            <button type="submit" formaction="exportexcelscrapdownload" class="btn btn-success"><i
