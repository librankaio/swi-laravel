...
class PemasukkanExport2 implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths, WithColumnFormatting
{
    protected $results;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        for ($row = $tableHeader2 + 1; $row <= $highestRow; $row++) {
            ...
            // Enable text wrapping for Supplier column (G) and Nama Barang column (I)
